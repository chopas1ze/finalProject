	...
	<form name="frm" id="frm" method="post" enctype="multipart/form-data" onsubmit="return process()">
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="id" size="50" maxlength="50" value="${mem.id}" readonly="readonly"/></td>
			</tr>

			<tr>
				<td width="20%" align="center">제목</td>
				<td><input type="text" name="e_title" size="50" maxlength="100" /></td>
			...
			<tr>
				...
				<td><textarea name="e_contents" rows="20" cols="100"></textarea></td>
			</tr>
