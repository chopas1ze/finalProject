...
<body>
	<c:if test="${sessionScope.mem.userchk=='S'}">
		<script>
			alert('구매자가 아닙니다.');
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 main test">
					<h2 class="page-header">판매자 신청페이지</h2>

					<form class="form-horizontal" id="nsfrm" method="POST">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="nsID">ID</label>
							<div class="col-sm-6">
								<input class="form-control" id="nsID" type="text" name="id"
									readonly="readonly" value="${mdto[0].id}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="nsName">이름</label>
							<div class="col-sm-6">
								<input class="form-control" id="nsName" type="text"
									readonly="readonly" value="${mdto[0].name}">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="nsSaupja_num">사업자
								번호</label>
							<div class="col-sm-6">
								<input class="form-control" id="nsSaupja_num" type="text"
									name="saupja_num">
							</div>
						</div>
						<label>이용 약관</label> 
						...
						<textarea class="form-control" rows="20" cols="5" readonly>
이 약관은 The Pub 주식회사 ("회사" 또는 "The Pub")가 제공하는 The Pub 및 The Pub 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 The Pub 및 The Pub 관련 제반 서비스를 의미합니다.
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
						...
						<div id="div2">
							<input type="radio" id="rb1" name="gg" /><label for="rb1">약관에
								동의합니다.</label> <input type="radio" id="rb2" name="gg" checked="checked" />
							<label for="rb2">약관에 동의 하지 않습니다.</label>
						</div>
						<input type="hidden" name="allow_chk" value="R" /> <input
							type="hidden" name="userchk" value="${mdto[0].userchk}" />
						<div class="form-group">
							<div class="col-sm-12 text-center">
								<button class="btn btn-primary" type="button" id="nsbtn">
									신청하기</button>
								<button class="btn btn-danger" type="button" id="nscanclebtn">
									취소</button>
							</div>
						</div>
					</form>
