...
@Override
	public CouponDTO chkid(String id) {
		
		return sqlSession.selectOne("event.idchk1", id);
	}

@Override
	public CouponDTO chkid2(String id) {
		return sqlSession.selectOne("event.idchk2", id) ;
	}

@Override
	public CouponDTO chkid3(String id) {
		return sqlSession.selectOne("event.idchk3", id);
	}
