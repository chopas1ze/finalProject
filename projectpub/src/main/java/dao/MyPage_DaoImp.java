...
@Override
public int checkMsgMethod(String id) {
	return sqlSession.selectOne("mypage.checkmesg",id);
};

@Override
public void checkOkMsgMethod(int num) {
	sqlSession.update("mypage.msgchecked",num);
};
