...
//		mav.addObject("mdtoid", id);
	...
	public @ResponseBody String cwriteMethod(String id) {
	
		 return	service.cinsertProcess(id);
					 
		
	}

	@RequestMapping(value = "/coupon2.do", method = RequestMethod.POST)
	public @ResponseBody String cwriteMethod2(String id) {
			
		return service.cinsertProcess2(id);
	}

	@RequestMapping(value = "/coupon3.do", method = RequestMethod.POST)
	public @ResponseBody String cwriteMethod3(String id) {
			
		return service.cinsertProcess3(id);
	}
